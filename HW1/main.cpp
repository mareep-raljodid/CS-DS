...
file_reenter:
    ...
    if ((a == 'y') || (a == 'Y')) {
        ...
        cout << "e: " << (ctar[6] / tot) * 100 << "%" << endl;
        cout << "f: " << (ctar[7] / tot) * 100 << "%" << endl;
        cout << "g: " << (ctar[8] / tot) * 100 << "%" << endl;
        cout << "h: " << (ctar[9] / tot) * 100 << "%" << endl;
        cout << "i: " << (ctar[10] / tot) * 100 << "%" << endl;
        cout << "j: " << (ctar[11] / tot) * 100 << "%" << endl;
        cout << "k: " << (ctar[12] / tot) * 100 << "%" << endl;
        cout << "l: " << (ctar[13] / tot) * 100 << "%" << endl;
        cout << "m: " << (ctar[14] / tot) * 100 << "%" << endl;
        cout << "n: " << (ctar[15] / tot) * 100 << "%" << endl;
        cout << "o: " << (ctar[16] / tot) * 100 << "%" << endl;
        cout << "p: " << (ctar[17] / tot) * 100 << "%" << endl;
        cout << "q: " << (ctar[18] / tot) * 100 << "%" << endl;
        cout << "r: " << (ctar[19] / tot) * 100 << "%" << endl;
        cout << "s: " << (ctar[20] / tot) * 100 << "%" << endl;
        cout << "t: " << (ctar[21] / tot) * 100 << "%" << endl;
        cout << "u: " << (ctar[22] / tot) * 100 << "%" << endl;
        cout << "v: " << (ctar[23] / tot) * 100 << "%" << endl;
        cout << "w: " << (ctar[24] / tot) * 100 << "%" << endl;
        cout << "x: " << (ctar[25] / tot) * 100 << "%" << endl;
        cout << "y: " << (ctar[26] / tot) * 100 << "%" << endl;
        cout << "z: " << (ctar[27] / tot) * 100 << "%" << endl;
    }
